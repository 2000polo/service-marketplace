    ...
    <div className="flex min-h-screen w-full bg-background text-foreground">
      ...
      <div className="mx-auto flex w-full max-w-6xl items-center justify-center p-4 lg:p-8">
        <div className="grid w-full grid-cols-1 overflow-hidden rounded-3xl border border-border/40 bg-card/20 shadow-2xl backdrop-blur-xl lg:grid-cols-2 lg:p-4">
          ...
          {/* Left Visual Side */}
          <div className="relative hidden flex-col items-center justify-end overflow-hidden rounded-2xl bg-gradient-to-b from-primary/20 via-background/60 to-background p-8 lg:flex lg:min-h-[680px]">
            {/* Ambient Glow */}
            ...
            <div className="z-10 flex flex-col items-center text-center">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Join our community to find or offer local services near you.
              </p>
            </div>
          </div>

          {/* Right Form Side */}
          <div className="flex flex-col justify-center px-6 py-8 sm:px-12 lg:px-16">
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    ...
                    >
                      <Briefcase className="mb-1 h-4 w-4" />
                      <span className="text-xs font-medium">Provide Services</span>
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-xl border border-border/60 bg-background/50 px-3.5 py-2 text-sm outline-none transition-all focus:border-primary focus:ring-2 focus:ring-primary/20"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      minLength={6}
                      className="w-full rounded-xl border border-border/60 bg-background/50 px-3.5 py-2 pr-10 text-sm outline-none transition-all focus:border-primary focus:ring-2 focus:ring-primary/20"
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
